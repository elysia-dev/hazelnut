...
function BuyingSummary(props: Props) {
  ...
  return (
    <div style={{ paddingTop: 20}}>
      <p style={{  fontSize:25, fontWeight: 'bold', marginBottom:12, textAlign: "center"}}>{`${t('Buying.CreateTransaction')} (${props.token.title})`}</p>
      <GrayBox> 
       <WhiteBox>
          <SpanWrapper>
            <GraySpan > FROM </GraySpan>
            <GraySpan> TO </GraySpan>
            <GraySpan> VALUE </GraySpan>
          </SpanWrapper>
          <div style={{ flex:1 }}>
          ...
          <SpanWrapper >
            ...
            <BlackSpan style={{flex:1}}> EL {expectedElValue.toFixed(2)} </BlackSpan>
          </SpanWrapper>
        </WhiteBox>
        ...
        <div style={{ flex:1 }}>
          ...
          <SpanWrapper>
            <BlackSpan> ELYSIA </BlackSpan>
            <BlackSpan> YOU </BlackSpan>
            <BlackSpan> ELA {props.token.amount} </BlackSpan>
          </SpanWrapper>
        </WhiteBox>
        </GrayBox>   
    </div>

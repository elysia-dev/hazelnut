...
function BuyingSummary(props: Props) {
  ...
  return (
    <div style={{ paddingTop: 20 }}>
      <p style={{ fontSize: 25, fontWeight: 'bold', marginBottom: 12, textAlign: "center" }}>
      ...
      <GrayBox>
        ...
        <WhiteBox>
          ...
          <SpanWrapper>
            ...
            <BlackSpan style={{ flex: 3, textAlign: "right" }}>{props.transactionRequest.tokenName} {props.transactionRequest.amount} </BlackSpan>
          </SpanWrapper>
        </WhiteBox>
      </GrayBox>
    </div>
